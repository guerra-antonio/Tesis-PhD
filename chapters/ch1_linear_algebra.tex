...
\end{equation}
This construction establishes a one-to-one, conjugate-linear correspondence, known as the Riesz representation, between vectors in $\mathcal{V}$ and elements of the dual space $\mathcal{V}^\ast$, allowing vectors and linear functionals to be treated within a unified framework.
