...
Unitary channels correspond to pure Choi states, which can be written as $J_U = \ket{J_U}\bra{J_U}$ and $J_V = \ket{J_V}\bra{J_V}$. For the comparison of unitary channels we adopt the \emph{gate fidelity}, defined as the squared overlap of their Choi states---equivalently, the square of the state fidelity of Eq.~\eqref{eq:fidelity} evaluated on these pure states,
\begin{equation}
