...
It is useful to introduce a correspondence between vectors in $\mathbb{R}^3$ and the space of traceless Hermitian $2 \times 2$ matrices. This correspondence is naturally established through the Pauli matrices, which span the traceless Hermitian $2\times 2$ matrices, i.e.\ the generators of $SU(2)$ (the elements of $\mathfrak{su}(2)$ up to a factor of $i$). Within this framework, any single-qubit density matrix can be parametrized in terms of a real three-dimensional vector, known as the Bloch vector.
